...
normal_curve2=exp(-((dd2-mu2).^2)/(2*sigma2*sigma2)) ./(sigma2*((2*pi)^(0.5)));
plot(dd2,normal_curve2,'OR')
...
rayleigh_curve2=(dd2./(sigma2*sigma2)).*(exp(-(dd2.*dd2)./(2*sigma2*sigma2)));
plot(dd2,rayleigh_curve2,'OR')
