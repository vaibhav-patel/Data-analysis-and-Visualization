...
% $Revision: 1.1.6.49 $  $Date: 2011/05/17 02:22:06 $
...
[dom,cellBoundaries] = m2mxdom(code,options.parserVersion);
...
% parserVersion is undocumented and may be removed without notice.
if ~isfield(options,'parserVersion')
    if ispref('publish','parserVersion')
        options.parserVersion = getpref('publish','parserVersion');
    else
